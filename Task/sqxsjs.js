...
function vediodrawprize(k) {
  ...
  const request = {
      url: url,
      headers: {"Accept": "*/*","Accept-Encoding": "gzip, deflate, br","Accept-Language": "zh-Hans-HK;q=1, ja-JP;q=0.9, zh-Hant-HK;q=0.8, yue-Hant-HK;q=0.7","Connection": "keep-alive","Content-Length": "1558","Content-Type": "application/x-www-form-urlencoded","Cookie": " isg=BJCQTYBKxC1N2ZgpMUkXXwj1a9riWXSjpS8waophI-vexT1vMmmJMkW3mQslDix7; cna=F/nEGGYGoQQCAd18Qgx44T2w","Host": "ocean.shuqireader.com","User-Agent": "shuqireader/4.3.6 (iPhone; iOS 13.6.1; Scale/3.00)"}},
