        ...
        setTimeout(() => {
            ...
            let url = {
                ...
                headers: {
                    ...
                    "User-Agent": "VeiShop, 1.4.8 (iOS, 13.6.1, zh-Hans_HK, Apple, iPhone, 1196C967-EE8A-496A-80C8-1BC260F39F7C)",
                    "X-User-Agent": "VeiShop, 1.4.8 (iOS, 13.6.1, zh-Hans_HK, Apple, iPhone, 1196C967-EE8A-496A-80C8-1BC260F39F7C)",
...
function playo(timeout = 0) {
    return new Promise((resolve) => {
        setTimeout(() => {
            ...
            const url = `https://veishop.iboxpay.com/nf_gateway/nf_content_service/video/ignore_tk/v1/video_channel/uplaod_play_video_recode.json`;
            return fetch(url, {
		    method:'POST',
            body: playbodyVal,
			headers: headers,
